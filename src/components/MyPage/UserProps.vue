...
<template>
    ...
    <div class="application" v-if="props.application" @click="navigateTo(`/recruit/${state.recruit.id}`)">
      <div class="component" >{{ state.recruit["title"] }}</div>
      <div>
        <div class="status" v-if="application.recruitStatus =='대기'">{{ application.recruitStatus }}</div>
        <div class="status-Y" v-if="application.recruitStatus =='수락'">{{ application.recruitStatus }}</div>
        <div class="status-N" v-if="application.recruitStatus =='거절'">{{ application.recruitStatus }}</div>
      </div>
    </div>
